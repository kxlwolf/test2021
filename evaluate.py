...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/vehicle.yaml', help='*.data path')
    parser.add_argument('--weights', nargs='+', type=str, default='./weights/vehicle/best_x.pt', help='model.pt path(s)')
